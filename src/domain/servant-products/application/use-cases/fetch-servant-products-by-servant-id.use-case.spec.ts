...
import { FetchServantProductsByServantIdUseCase } from './fetch-servant-products-by-servant-id.use-case'
...
describe('Fetch All Servant Products', () => {
  ...
  let sut: FetchServantProductsByServantIdUseCase

  beforeEach(() => {
    inMemoryServantProductsRepository = new InMemoryServantProductsRepository()
    sut = new FetchServantProductsByServantIdUseCase(
