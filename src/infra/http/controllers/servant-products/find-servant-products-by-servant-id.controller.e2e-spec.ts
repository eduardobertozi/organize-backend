...
describe('Find Servant Products (E2E)', () => {
  ...
  test('[GET] /servant-products/:servantId', async () => {
    ...
    const response = await request(app.getHttpServer())
      .get(`/servant-products/${servant.id.toString()}`)
    ...
    expect(servantProductOnDatabase).toBeTruthy()
  })
})
